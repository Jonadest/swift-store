...
import "./login.css";
import SignupImage from "../Login Signup/signup.jpg";
    ...
    <div className="wrapper">
      <div className="login-body d-lg-flex d-flex-sm-colum col-lg-8 mb-4  ">
        <div className="img-side d-none d-lg-block">
          ...
          <p className="c-acct text-center ">
            <Link to="/login">
          ...
          <div className="form">
            ...
            <main class="form-signin  m-auto">
              <form>
                ...
                <button class="bbt  col-4  col-lg-6 py-2" type="submit">
                  Sign in
                </button>
                ...
                <p className="c-acct lgcc text-center ">
                  <Link to="/login">
                    Already have account? <strong>Sign in</strong>
                  </Link>
                </p>
